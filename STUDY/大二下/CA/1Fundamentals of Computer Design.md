# Fundamentals of Computer Design[¶](https://note.hobbitqia.cc/CA/CA1/#fundamentals-of-computer-design "Permanent link")

 约 1070 个字  7 张图片  预计阅读时间 4 分钟

![](https://cdn.hobbitqia.cc/20230921202940.png)

## Introduction[¶](https://note.hobbitqia.cc/CA/CA1/#introduction "Permanent link")

Von Neumann Structure

![](https://cdn.hobbitqia.cc/20230921203050.png)
...
![](https://cdn.hobbitqia.cc/20230921203255.png)
...
## Performance[¶](https://note.hobbitqia.cc/CA/CA1/#performance "Permanent link")
...
**_The main goal of architecture improvement is to improve the performance of the system._**

## Technology Trend[¶](https://note.hobbitqia.cc/CA/CA1/#technology-trend "Permanent link")
...
## Quantitative approaches[¶](https://note.hobbitqia.cc/CA/CA1/#quantitative-approaches "Permanent link")

### CPU Performance[¶](https://note.hobbitqia.cc/CA/CA1/#cpu-performance "Permanent link")
...
### Amdahl's Law[¶](https://note.hobbitqia.cc/CA/CA1/#amdahls-law "Permanent link")
...
- - 其中  为被优化部分的加速比， 为整体加速比， 为被优化部分所占的运行时间比例

## Great Architecture Ideas[¶](https://note.hobbitqia.cc/CA/CA1/#great-architecture-ideas "Permanent link")
...
## ISA[¶](https://note.hobbitqia.cc/CA/CA1/#isa "Permanent link")

- Instruction Set Architecture

![](https://cdn.hobbitqia.cc/20230928223516.png)
...
### ISA Classification Basis[¶](https://note.hobbitqia.cc/CA/CA1/#isa-classification-basis "Permanent link")
...
### GPR Classification[¶](https://note.hobbitqia.cc/CA/CA1/#gpr-classification "Permanent link")

![](https://cdn.hobbitqia.cc/20230928225257.png)

![](https://cdn.hobbitqia.cc/20230928225337.png)

A+B

![](https://cdn.hobbitqia.cc/20230928225409.png)

More: try to do with 

GPR 速度快，但是 GPR 太多也会有资源的浪费和性能下降（如寻找对应的寄存器）

2023年9月30日 09:19:27 2023年9月21日 20:43:40